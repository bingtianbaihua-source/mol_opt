...
from src.utils import NodeVector, EdgeVector, GraphVector, PropertyVector
...
from src.transform import NUM_ATOM_FEATURES, NUM_BOND_FEATURES, NUM_BLOCK_FEATURES
